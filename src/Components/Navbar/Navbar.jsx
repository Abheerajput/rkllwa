...
const Navbar = () => {
 ...
 <div className="bg-[#E0AF04]  px-[5.2%] py-4 ">
      <div className="flex justify-between items-center">
        <p className="fgt-ff-medium  sx:text-[12px] text-[24px] lg:text-[22px] text-white md:text-[20px]">FinCEN's beneficial owner <br className='hidden xs:block'/> compliance   <br className='hidden sm:block'/>made easy for companies <i>nationwide</i>  </p>
