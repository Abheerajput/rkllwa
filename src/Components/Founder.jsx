...
const FounderCard = ({ imgSrc, name, position, description }) => (
  <div className='flex bg-[#403C5C] mx-12 xs:mx-0 xs:flex-col md:flex md:flex-col relative mt-14'>
    <img src={imgSrc} alt={name} className=' ' />
    <div className='w-full xs:px-4 xs:mx-0 md:mx-0 md:px-4 mx-12'>
      ...
      <p className='text-[26px] font-semibold text-[#FFEDD7] py-6 cursor-pointer'>More Info</p>
    </div>
  </div>
);
