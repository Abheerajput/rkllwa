...
<div className="text-[26px] xs:text-[20px] fgt-ff-normal pl-[5.2%] text-[#403C5C] bg-[#F7F6F1] py-4">
      ...
      <div className="bg-gray-50 w-full  px-[5.2%]  xs:flex xs:flex-col sm:flex sm:flex-col  md:flex md:flex-col sm:p-10">  
          ...
          <div className="flex xs:flex-col md:flex-col xs:items-start  xs:gap-0 md:items-center px-4 mt-[24px] gap-12 items-start ">
            <img 
              src={profile} 
              alt="Ava Johnson" 
            ...
            <div className="flex-1">
              ...
              <h2 className="text-[32px] fgt-ff-medium text-[27px] text-[#403C5C] mb-4">Attorney</h2>
